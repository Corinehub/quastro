            ...
            <div class="row justify-content-center align-items-center h-100">
                <div class="col-xxl-6 col-xl-7 col-lg-7 col-md-7 col-sm-8 col-12">
                    <div class="p-5">
                        ...
                        <form class="row" method="POST" action="{{ route('auth.store') }}">
                            ...
                            <div class="row gy-3">
                                ...
                                <div class="col-xl-12 mb-3">
                                    <label for="signup-confirmpassword" class="form-label text-default"> Confirmer votre
                                        mot de pase
                                    </label>
                                    <div class="input-group">
                            ...
                            <div class="text-center">
                                <p class="fs-12 text-muted mt-4">Vous avez déja un compte? <a
                                        href="{{ route('login.dao',$daoResult->id) }}" class="text-primary">Connexion</a></p>
                            </div>
                        </form>
                    </div>
                </div>
