                ...
                <div class="d-sm-flex align-items-top p-4 border-bottom-0 main-profile-cover">
                    ...
                    <div class="flex-fill main-profile-info">
                        <div class="d-flex align-items-center justify-content-between">
                            <h6 class="fw-semibold mb-1 text-fixed-white">{{ auth()->user()->provider->name }}</h6>
                            <button class="btn btn-light btn-wave"><i
                                    class="ri-add-line me-1 align-middle d-inline-block"></i>S'abonner
                            </button>
                        </div>
                        <p class="mb-1 text-muted text-fixed-white op-7">Chief Executive Officer (C.E.O)</p>
                        <p class="fs-12 text-fixed-white mb-4 op-5">
                            <span class="me-3"><i
                                    class="ri-building-line me-1 align-middle"></i>{{ auth()->user()->provider->address }}</span>
                            <span><i
                                    class="ri-map-pin-line me-1 align-middle"></i>{{ auth()->user()->provider->phone }}</span>
                        </p>
                ...
                <div class="p-4 border-bottom border-block-end-dashed">
                    <div class="mb-4">
                        ...
                        <p class="fs-12 text-muted op-7 mb-0">
                            I am <b class="text-default">{{ auth()->user()->provider->name }},</b> here by conclude that,i am the founder
                            ...
                            <ul class="list-group">
                                <li class="list-group-item">
                                    <div class="d-flex flex-wrap align-items-center">
                                        ...
                                        <span class="fs-12 text-muted">{{ auth()->user()->provider->name }}</span>
                                    </div>
                                </li>
                                <li class="list-group-item">
                                    <div class="d-flex flex-wrap align-items-center">
                                ...
                                <li class="list-group-item">
                                    <div class="d-flex flex-wrap align-items-center">
                                        ...
                                        <span class="fs-12 text-muted">{{ auth()->user()->provider->phone }}</span>
                                    </div>
                                </li>
                                {{-- <li class="list-group-item">
                                    <div class="d-flex flex-wrap align-items-center">
