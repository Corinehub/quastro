            ...
            <div class="ms-md-1 ms-0">
                <nav>
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Ajouter DAO</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="col-xl-12  ">
                <div class="card custom-card ">
                    ...
                    <div class="card-body">
                        ...
                        <form class="row" method="POST" action="{{ route('dao.store') }}">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="name"
                                    ...
                                    placeholder=" {{ __('Insérer le nom du DAO') }}" aria-label="">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="category"
                                    ...
                                    value="{{ old('category') }}" placeholder="{{ __('Insérer la catégorie du DAO') }}"
                                    aria-label="">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-12 mb-3">
                                        ...
                                        <input type="text" name="dao_submission_confirmation_message"
                                            ...
                                            value="{{ old('dao_submission_confirmation_message') }}"
                                    ...
                                    <div class="col-xl-6 mb-3">
                                        ...
                                        <input type="text" name="state" value="{{ old('state/province') }}"
                                    ...
                                    <div class="col-xl-6 mb-3">
                                        ...
                                        <select name="country" value="{{ old('country') }}" class="form-select @error('country') is-invalid @enderror">
                                ...
                                <div class="row">
                                    <div class="col-xl-12 mb-3">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="number" name="prices" value="{{ old('prices') }}" class="form-control @error('prices') is-invalid @enderror "
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label"> {{ __('Nombre max de Souscription') }} </label>
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="number" name="max_number_subscribe" value="{{ old('max_number_subscribe') }}" class="form-control @error('max_number_subscribe') is-invalid @enderror "
                                            aria-label="Sizing example input"
                                            placeholder="nombre maximal de souscription"
                                            aria-describedby="inputGroup-sizing-default">
                                    </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-check mb-3">
                                    <input class="form-check-input" type="checkbox" value="{{ old('accep_submission_confirmation_past_due_date') }}"
