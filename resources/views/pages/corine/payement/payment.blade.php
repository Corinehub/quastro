...
<body>
        ...
        <div class="row justify-content-center authentication authentication-basic align-items-center h-100">
            <div class="col-xxl-4 col-xl-5 col-lg-5 col-md-6 col-sm-8 col-12">
                <div class="my-5 d-flex justify-content-center">
                    <a href="index.html">
                        <img src="/assets/images/images/brand-logos/desktop-logo.png" alt="logo" class="desktop-logo">
                        <img src="/assets/images/images/brand-logos/desktop-dark.png" alt="logo" class="desktop-dark">
                    </a>
                </div>
            ...
            <div class="card custom-card ">
                ...
                <div class="card-body">
                    <form id="form" class="row" method="POST"
                        action="{{ route('process.payment', $daoResult->id) }}">
                        @csrf
                        
                        <div>
                            <div class="fs-14 py-2 mb-3"><span
                                    class="fw-semibold text-dark">{{ __('Prix') }}:</span><span
                                    class="text-muted ms-2 fs-14 d-inline-block"
                                    name="cost">{{ $daoResult->prices }} </span><span
                                    class="text-dark fw-semibold float-end">FCFA</span>
                            </div>


                            <div class="row g-2">
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">{{ __('Nom du titulaire de la carte') }}</label>
                                    <input type="text" name="name" class="form-control "
                                        placeholder=" {{ __('Insérer le nom du titulaire de la carte') }}"
                                        aria-label="">
                                </div>
                            ...
                            <div class="col-12">
                                <button type="submit" id="card-button" class="btn btn-primary w-100">
                                    Souscrire
                                </button>
                            </div>
                        </div>
    ...
    <script>
        const stripe = Stripe(
            'pk_test_51PxRttBLfKWYHmGkZfAJA5ssVH5GGDQActqDYDsJEfIOhNTuvazeiZLbvNi9RYK89TFKhdlYLpGIING3qM81DiSF00Zwfk3BR4'
        )
        ...
        const cardElement = elements.create('card', {
            style: style,
            classes: {
                base: 'StripeElement   rounded'
            }
        });

        // Montre l'élément de carte dans la div avec l'ID 'card-element'
        cardElement.mount('#card-element');

        // Soumission du formulaire avec Stripe
        ...
        cardButton.addEventListener('click', async (e) => {
            ...
            if (error) {
                alert(error.message); // Affichage de l'erreur si elle existe
            } else {
                document.getElementById('payment_method').value = paymentMethod
                    .id; // Envoi de l'ID de méthode de paiement au backend
                document.getElementById('form').submit(); // Soumission du formulaire
            }
        });
    </script>
    <!-- Bootstrap JS -->
