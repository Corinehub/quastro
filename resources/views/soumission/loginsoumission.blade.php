            ...
            <div class="row justify-content-center align-items-center h-100">
                <div class="col-xxl-6 col-xl-7 col-lg-7 col-md-7 col-sm-8 col-12">
                    <div class="p-5">
                        <div class="mb-3">
                            <a href="index.html">
                                <img src="../assets/images/images/brand-logos/desktop-logo.png" alt=""
                                    class="authentication-brand desktop-logo">
                                <img src="../assets/images/images/brand-logos/desktop-dark.png" alt=""
                        ...
                        <form class="row" method="POST" action="{{ route('soumission.loginuser') }}">
                            ...
                            <div class="row gy-3">
                                ...
                                <div class="col-xl-12 mb-3">
                                    <label for="signin-password"
                                        class="form-label text-default d-block">{{ __('Mot de passe') }}<a
                                            href="reset-password-cover.html" class="float-end ">Mot de passe oublié
                                            ?</a></label>
                                    <div class="input-group">
                                        <input type="password" name="password"
                                            class="form-control  @error('password') is-invalid @enderror"
                                            value="{{ old('password') }}" id="signin-password"
                                            placeholder="mot de passe">

                                        <button class="btn btn-light" type="button" name="password"
                            ...
                            {{-- <div class="text-center">
                                <p class="fs-12 text-muted mt-4">Vous n'avez pas de compte ? <a
                                        href="{{ route('register', $daoResult->id) }}" class="text-primary">Enregistrez-vous</a></p>
                            </div> --}}
                        </form>
                    </div>
