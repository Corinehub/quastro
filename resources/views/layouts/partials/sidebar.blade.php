<aside class="app-sidebar sticky" id="sidebar">
    ...
    <div class="main-sidebar-header">
        <a href="index.html" class="header-logo">
            ...
            <img src="/assets/images/images/LOGO_QUASTROM/PNG/Fichier_2.png" alt="logo" class="toggle-logo">
            <img src="/assets/images/images/LOGO_QUASTROM/PNG/Fichier_1.png" alt="logo" class="desktop-dark">
            <img src="/assets/images/images/LOGO_QUASTROM/PNG/Fichier_2.png" alt="logo" class="toggle-dark">
            <img src="/assets/images/images/LOGO_QUASTROM/PNG/Fichier_1.png" alt="logo" class="desktop-white">
            <img src="/assets/images/images/LOGO_QUASTROM/PNG/Fichier_2.png" alt="logo" class="toggle-white">
        </a>
    </div>
        ...
        <nav class="main-menu-container nav nav-pills flex-column sub-open">
            ...
            <ul class="main-menu">
                ...
                <li class="slide has-sub">
                    <a href="{{ route('provider.dashboard') }}" class="side-menu__item">
                        <i class="bx bx-home side-menu__icon"></i>
                        <span class="side-menu__label">Dashboards
                            {{-- <span class="badge bg-warning-transparent ms-2">12
                            </span> --}}
                        </span>
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide">
                            <a href="{{ route('dashboard') }}" class="side-menu__item">CRM</a>
                        </li> --}}
                ...
                <li class="slide has-sub">
                    <a href="javascript:void(0);" class="side-menu__item">
                        ...
                        <span class="side-menu__label">DAO
                            {{-- <span
                                class="badge bg-secondary-transparent ms-2">New
                            </span> --}}
                        </span>
                        <i class="fe fe-chevron-right side-menu__angle"></i>
                    </a>
                    <ul class="slide-menu child1">
                        <li class="slide side-menu__label1">
                            <a href="javascript:void(0)">DAO</a>
                        </li>
                        <li class="slide">
                            <a href="{{route('provider.index')}}" class="side-menu__item">Mes DAO</a>
                        </li>
                ...
                <li class="slide has-sub">
                    <a href="javascript:void(0);" class="side-menu__item">
                        ...
                        <span class="side-menu__label">soumission
                            {{-- <span
                                class="badge bg-secondary-transparent ms-2">New
                            </span> --}}
                        </span>
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide">
                            <a href="{{route('messoumission.dao')}}" class="side-menu__item">Mes soumissions</a>
                        </li>
                ...
                <li class="slide has-sub">
                    <a href="{{route('payment.index')}}" class="side-menu__item">
                        <i class="bx bx-medal side-menu__icon"></i>
                        <span class="side-menu__label">Paiement
                            {{-- <span
                                class="badge bg-secondary-transparent ms-2">New
                            </span> --}}
                        </span>
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide">
                            <a  class="side-menu__item">Mes soumissions</a>
                        </li> --}}
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide has-sub">
                            <a href="{{route('profile.provider')}}" class="side-menu__item">Profile
                                <i lass="fe fe-chevron-right side-menu__angle">
                                </i>
                            </a>
                        </li>
                        ...
                        {{-- <li class="slide has-sub">
                            <a href="{{route('register', $daoResult->dao)}}" class="side-menu__item">Reset Password
                                <i class="fe fe-chevron-right side-menu__angle"></i></a>

                        </li> --}}

                        <li class="slide has-sub">
                            <a class="side-menu__item" href="{{route('auth.logout')}}">Déconnexion<i
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide has-sub">
                            <a class="side-menu__item" href="javascript:void(0);">Support<i
