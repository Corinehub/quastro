        ...
        <nav class="main-menu-container nav nav-pills flex-column sub-open">
            ...
            <ul class="main-menu">
                ...
                <li class="slide has-sub">
                    <a href="{{ route('dao.dashboard') }}" class="side-menu__item">
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide">
                            <a href="{{route('dao')}}" class="side-menu__item">Liste DAO</a>
                        </li>
                ...
                <li class="slide has-sub">
                    <a href="javascript:void(0);" class="side-menu__item">
                        ...
                        <span class="side-menu__label">Souscriptions
                            {{-- <span
                                class="badge bg-secondary-transparent ms-2">New
                            </span> --}}
                        </span>
                    ...
                    <ul class="slide-menu child1">
                        <li class="slide side-menu__label1">
                            <a href="javascript:void(0)">souscriptions</a>
                        </li>
                        <li class="slide">
                            <a href="{{route('list_souscription')}}" class="side-menu__item">liste de souscriptions</a>
                        </li>
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide has-sub">
                            <a href="{{route('profile')}}" class="side-menu__item">Profile
